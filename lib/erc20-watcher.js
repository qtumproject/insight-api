        ...
        return async.eachSeries(block.txids, function (txHash, callback) {
            ...
            return self.node.getJsonRawTransaction(txHash, function (err, transaction) {
                ...
                return async.waterfall([function (callback) {
                    ...
                    return self.processCall(blockHeight, txHash, receipt, callVouts, function (err) {
                        return callback(err);
                    });
 ...
 * @return {*}
 */
Erc20Watcher.prototype.processCall = function (blockHeight, txHash, receipt, callVouts, callback) {
    ...
    return async.waterfall([function (callback) {
        ...
        return self.processReceipt(receipt, txHash, function (err) {
            return callback(err);
        });
    ...
    return async.waterfall([function (callback) {
        ...
        return async.eachOfSeries(createVouts, function (vout, voutCreateIdx, callback) {
            if (vout.scriptPubKey && vout.scriptPubKey.type === 'create' && ContractsHelper.isErc20Contract(vout.scriptPubKey.hex)) {
                ...
                console.log('voutCreateIdx', blockHeight, voutCreateIdx, txHash, ContractsHelper.getContractAddress(txHash, vout.n));
 ...
 * @return {*}
 */
Erc20Watcher.prototype.processReceipt = function(receipt, txHash, callback) {
